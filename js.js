...
var thisSearchIcon = './images/logo.jpg';
...
$("#content a").mouseover(function(){
	var aColor=["Aqua","Aquamarine","DeepSkyBlue","DeepPink","Fuchsia","Gold","GreenYellow","HotPink","LawnGreen","Turquoise",];
	$(this).css('background-color', aColor[Math.floor((Math.random()*10))]);
	})
$("#content a").mouseout(function(){$(this).css('background-color', 'white');})
/*
* @Author: Marte
